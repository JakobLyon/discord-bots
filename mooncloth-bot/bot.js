    ...
    switch (cmd) {
      ...
      case "mooncloth make":
        ...
        new Promise((resolve, reject) => {
          ...
          const earlyReminder = moonclothTimer.subtract(
            EARLY_CD_REMINDER_DAYS,
            "days"
          );
          const recurringReminder = moonclothTimer.add(
            POST_CD_REMINDER_HOURS,
            "hours"
          );
          ...
          eventsLogger.info({
            userID,
            message: `Your mooncloth will be ready to craft on ${earlyReminder.format("LL")} ${earlyReminder.format("LT")}`,
